...
public class SPTiles {
    ...
    public static final BlockEntityEntry<DynamoTileEntity> DYNAMO = REGISTRATE
            ...
            .onRegister((dynamoTileEntityBlockEntityType -> EnergyStorage.SIDED.registerForBlockEntity(((blockEntity, direction) -> blockEntity.energy), dynamoTileEntityBlockEntityType)))
            .register();
